...
public class StaticOverrideTest {
	...
	public static void main(String[] args) {
		...
		p.name(); // as per overriding rules this should call to child's static overridden method. Since static method can not be overridden, it will call parent static method because Type of p is Parent.
