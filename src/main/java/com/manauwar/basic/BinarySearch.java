...
public class BinarySearch {
	...
	public static void main(String[] args) {
		...
		int input[] = { 33, 23, 98, 100, 45, 60, 73, 81, 87, 39, 111 };
		int number = 111;
		...
		System.out.println("Searched at position : "+searched);
		...
		System.out.println("Searched at position : "+searchedByRecursive);
